...
def get_argparse():
    ...
    # MED-ASD waveform feature extractor
    parser.add_argument('--med_sample_rate', type=int, default=16000,
                        help='Sample rate for MED-ASD waveform loading')
    parser.add_argument('--med_audio_samples', type=int, default=160000,
                        help='Number of waveform samples used by MED-ASD per file')
    parser.add_argument('--med_batch_size', type=int, default=4,
